...
SEED_ARTISTS = [
    ...
    (26, "Pixel Romance",    "South Korea", 2021, 12300000, "K-Pop"),
    (27, "Asha Meridian",    "UK",          2019,  4700000, "Neo-Soul"),
    (28, "Cumbia Digital",   "Colombia",    2017,  5900000, "Electronic Cumbia"),
    (29, "Wolf Latitude",    "Iceland",     2020,  3100000, "Post-Rock"),
    (30, "Jade Circuit",     "Singapore",   2022,  8200000, "Hyperpop"),
]
...
SEED_SONGS = [
    ...
    # Pixel Romance (26) - K-Pop
    (76, "Starfall Protocol",  26, "K-Pop",           136, "Playful",    198, 2022),
    (77, "Neon Confetti",      26, "K-Pop",           142, "Euphoric",   205, 2023),
    (78, "Gravity Romance",    26, "K-Pop",           130, "Romantic",   218, 2024),
    (79, "Orbit",              26, "K-Pop",           138, "Confident",  202, 2025),
    # Asha Meridian (27) - Neo-Soul
    (80, "River of Glass",     27, "Neo-Soul",         82, "Melancholy", 272, 2021),
    (81, "Ember & Rain",       27, "Neo-Soul",         78, "Sad",        255, 2022),
    (82, "Gold Frequency",     27, "Neo-Soul",         90, "Sensual",    288, 2023),
    (83, "Bloom Theory",       27, "Neo-Soul",         86, "Uplifting",  263, 2025),
    # Cumbia Digital (28) - Electronic Cumbia
    (84, "Baile Glitch",       28, "Electronic Cumbia",116, "Energetic", 223, 2020),
    (85, "Noche Sintetica",    28, "Electronic Cumbia",110, "Playful",   208, 2022),
    (86, "Marimba 3000",       28, "Electronic Cumbia",122, "Joyful",    195, 2023),
    (87, "Carnaval Glitch",    28, "Electronic Cumbia",118, "Energetic", 212, 2025),
    # Wolf Latitude (29) - Post-Rock
    (88, "Tundra Bloom",       29, "Post-Rock",        88, "Wistful",    412, 2021),
    (89, "Ash Meridian",       29, "Post-Rock",        72, "Melancholy", 387, 2022),
    (90, "Patagonia Signal",   29, "Post-Rock",        80, "Wistful",    398, 2025),
    # Jade Circuit (30) - Hyperpop
    (91, "Sugar Crash",        30, "Hyperpop",        158, "Playful",    178, 2022),
    (92, "Glitch Princess",    30, "Hyperpop",        162, "Aggressive", 165, 2023),
    (93, "Bubble Protocol",    30, "Hyperpop",        170, "Euphoric",   172, 2024),
    (94, "Hyper Bloom",        30, "Hyperpop",        155, "Euphoric",   175, 2024),
    (95, "Jade Frequency",     30, "Hyperpop",        166, "Playful",    168, 2025),
    # 2025 new releases from existing artists
    (96,  "Dusk Operator",      1, "Electronic",      136, "Dark",       205, 2025),
    (97,  "Summer Algorithm",  12, "K-Pop",           134, "Cheerful",   211, 2025),
    (98,  "Monsoon Neon",       7, "Bollywood Fusion",112, "Energetic",  238, 2025),
    (99,  "Cobre Remix",        4, "Latin",           106, "Romantic",   225, 2025),
    (100, "Petrichor",         21, "Ambient",          58, "Calm",       412, 2025),
    (101, "Static Rain",       10, "Synth-pop",       124, "Nostalgic",  231, 2025),
    (102, "Hanoi Nights",      17, "Hip-hop Fusion",   94, "Cool",       241, 2025),
    (103, "Oye Riddim",        23, "Afrobeats",       120, "Joyful",     194, 2025),
    (104, "Velvet Protocol",   14, "R&B",              86, "Sensual",    259, 2025),
    (105, "Neo Drift",         16, "Electropop",      122, "Uplifting",  208, 2025),
    (106, "Coastal Static",     2, "Indie Rock",       98, "Wistful",    265, 2025),
    (107, "Midnight Rust",     22, "Indie Folk",       82, "Melancholy", 290, 2025),
    (108, "Raga Digital",       7, "Bollywood Fusion",108, "Nostalgic",  245, 2025),
    (109, "Glass Aurora",      18, "Nordic Folk Electronic", 110, "Wistful", 278, 2025),
    (110, "Techno Mantra",     24, "Techno",          148, "Tense",      320, 2025),
]
...
SEED_USERS = [
    ...
    (51, "hyperpop_sg",      "Singapore",    "premium", 2022, 20),
    (52, "neo_soul_london",  "UK",           "free",    2021, 28),
    (53, "cumbia_bogota",    "Colombia",     "premium", 2020, 32),
    (54, "post_rock_reykj",  "Iceland",      "free",    2022, 29),
    (55, "kpop_new_gen",     "South Korea",  "premium", 2023, 17),
    (56, "deep_house_ibiza", "Spain",        "premium", 2021, 30),
    (57, "folk_reykjavik",   "Iceland",      "free",    2022, 35),
    (58, "rnb_paris",        "France",       "premium", 2020, 27),
    (59, "lofi_bangkok",     "Thailand",     "free",    2023, 21),
    (60, "electro_madrid",   "Spain",        "premium", 2021, 26),
    (61, "jazz_new_york",    "USA",          "premium", 2019, 44),
    (62, "indie_cape",       "South Africa", "free",    2022, 25),
    (63, "bass_sao_paulo",   "Brazil",       "premium", 2020, 31),
    (64, "synth_chicago",    "USA",          "premium", 2021, 29),
    (65, "world_music_fan",  "UAE",          "premium", 2020, 38),
    (66, "tech_nairobi",     "Kenya",        "free",    2023, 22),
    (67, "k_indie_busan",    "South Korea",  "free",    2022, 24),
    (68, "latin_miami",      "USA",          "premium", 2019, 33),
    (69, "afro_london",      "UK",           "premium", 2021, 26),
    (70, "chiptune_tokyo",   "Japan",        "free",    2022, 19),
    (71, "classic_vienna",   "Austria",      "premium", 2020, 45),
    (72, "trap_atlanta_2",   "USA",          "free",    2023, 20),
    (73, "ambient_sydney",   "Australia",    "premium", 2021, 34),
    (74, "metal_prague",     "Czech Republic","free",   2022, 31),
    (75, "reggaeton_lima",   "Peru",         "premium", 2021, 27),
]
...
SEED_STREAMS = [
    ...
    # --- User 51 (hyperpop_sg) — hyperpop
    (420, 51, 91, "2024-01-05 20:00:00", 1, None, "search"),
    (421, 51, 92, "2024-01-05 20:03:00", 1, None, "artist_page"),
    (422, 51, 93, "2024-01-08 21:00:00", 1, None, "playlist"),
    (423, 51, 94, "2024-01-15 20:00:00", 1, None, "recommendation"),
    (424, 51, 95, "2024-01-20 21:00:00", 0, 25,   "radio"),
    (425, 51, 91, "2024-02-01 20:00:00", 1, None, "search"),
    (426, 51, 92, "2024-02-10 21:00:00", 1, None, "playlist"),
    (427, 51, 94, "2024-03-01 20:30:00", 1, None, "recommendation"),
    # --- User 52 (neo_soul_london) — neo-soul
    (428, 52, 80, "2024-01-06 19:00:00", 1, None, "search"),
    (429, 52, 81, "2024-01-06 19:05:00", 1, None, "artist_page"),
    (430, 52, 82, "2024-01-12 20:00:00", 1, None, "recommendation"),
    (431, 52, 83, "2024-01-20 19:00:00", 0, 60,   "radio"),
    (432, 52, 80, "2024-02-01 19:00:00", 1, None, "playlist"),
    (433, 52, 81, "2024-02-10 20:00:00", 1, None, "search"),
    (434, 52, 82, "2024-02-20 19:30:00", 0, 45,   "recommendation"),
    # --- User 53 (cumbia_bogota) — electronic cumbia
    (435, 53, 84, "2024-01-04 18:00:00", 1, None, "search"),
    (436, 53, 85, "2024-01-04 18:04:00", 1, None, "artist_page"),
    (437, 53, 86, "2024-01-04 18:08:00", 1, None, "artist_page"),
    (438, 53, 87, "2024-01-10 19:00:00", 1, None, "recommendation"),
    (439, 53, 10, "2024-01-18 18:00:00", 0, 50,   "radio"),
    (440, 53, 84, "2024-02-01 18:00:00", 1, None, "playlist"),
    (441, 53, 85, "2024-02-10 19:00:00", 1, None, "search"),
    (442, 53, 86, "2024-02-20 18:30:00", 1, None, "recommendation"),
    (443, 53, 87, "2024-03-01 18:00:00", 1, None, "playlist"),
    # --- User 54 (post_rock_reykj) — post-rock
    (444, 54, 88, "2024-01-07 21:00:00", 1, None, "search"),
    (445, 54, 89, "2024-01-07 21:07:00", 1, None, "artist_page"),
    (446, 54, 90, "2024-01-15 20:00:00", 1, None, "recommendation"),
    (447, 54, 88, "2024-02-01 21:00:00", 1, None, "playlist"),
    (448, 54, 89, "2024-02-15 22:00:00", 1, None, "search"),
    (449, 54, 90, "2024-03-01 21:00:00", 0, 80,   "recommendation"),
    # --- User 55 (kpop_new_gen) — K-Pop
    (450, 55, 76, "2024-01-03 14:00:00", 1, None, "search"),
    (451, 55, 77, "2024-01-03 14:04:00", 1, None, "artist_page"),
    (452, 55, 78, "2024-01-03 14:08:00", 1, None, "artist_page"),
    (453, 55, 79, "2024-01-08 15:00:00", 1, None, "recommendation"),
    (454, 55, 97, "2024-01-15 14:00:00", 1, None, "search"),
    (455, 55, 76, "2024-02-01 14:00:00", 1, None, "playlist"),
    (456, 55, 77, "2024-02-10 15:00:00", 0, 30,   "radio"),
    (457, 55, 79, "2024-03-01 14:30:00", 1, None, "search"),
    # --- User 56 (deep_house_ibiza) — electronic/techno
    (458, 56,  1, "2024-01-05 23:00:00", 1, None, "search"),
    (459, 56,  2, "2024-01-05 23:04:00", 1, None, "playlist"),
    (460, 56, 61, "2024-01-10 22:00:00", 1, None, "recommendation"),
    (461, 56, 62, "2024-01-10 22:10:00", 1, None, "artist_page"),
    (462, 56, 96, "2024-01-20 23:00:00", 1, None, "search"),
    (463, 56,  3, "2024-02-01 22:00:00", 0, 40,   "radio"),
    (464, 56, 96, "2024-02-10 23:00:00", 1, None, "recommendation"),
    (465, 56,  1, "2024-03-01 23:00:00", 1, None, "playlist"),
    # --- User 57 (folk_reykjavik) — post-rock + indie folk
    (466, 57, 88, "2024-01-08 19:00:00", 1, None, "search"),
    (467, 57, 89, "2024-01-08 19:07:00", 1, None, "artist_page"),
    (468, 57, 57, "2024-01-15 20:00:00", 0, 75,   "recommendation"),
    (469, 57, 58, "2024-01-22 19:00:00", 1, None, "search"),
    (470, 57, 88, "2024-02-05 20:00:00", 1, None, "playlist"),
    (471, 57, 90, "2024-02-15 19:00:00", 1, None, "recommendation"),
    # --- User 58 (rnb_paris) — neo-soul + R&B
    (472, 58, 80, "2024-01-05 20:00:00", 1, None, "search"),
    (473, 58, 81, "2024-01-05 20:05:00", 1, None, "artist_page"),
    (474, 58, 32, "2024-01-12 19:00:00", 1, None, "recommendation"),
    (475, 58, 33, "2024-01-12 19:04:00", 1, None, "artist_page"),
    (476, 58,104, "2024-01-20 20:00:00", 1, None, "search"),
    (477, 58, 80, "2024-02-01 20:00:00", 1, None, "playlist"),
    (478, 58, 82, "2024-02-10 19:30:00", 1, None, "search"),
    (479, 58,104, "2024-03-01 20:00:00", 1, None, "recommendation"),
    # --- User 59 (lofi_bangkok) — lo-fi
    (480, 59, 19, "2024-01-04 22:00:00", 1, None, "search"),
    (481, 59, 20, "2024-01-04 22:04:00", 1, None, "playlist"),
    (482, 59, 21, "2024-01-04 22:08:00", 1, None, "playlist"),
    (483, 59, 70, "2024-01-10 23:00:00", 1, None, "recommendation"),
    (484, 59, 19, "2024-02-01 22:00:00", 1, None, "search"),
    (485, 59, 70, "2024-02-10 23:00:00", 1, None, "playlist"),
    (486, 59, 20, "2024-03-01 22:30:00", 0, 35,   "radio"),
    # --- User 60 (electro_madrid) — electropop
    (487, 60, 41, "2024-01-05 21:00:00", 1, None, "search"),
    (488, 60, 42, "2024-01-05 21:04:00", 1, None, "artist_page"),
    (489, 60, 96, "2024-01-12 22:00:00", 1, None, "recommendation"),
    (490, 60,105, "2024-01-20 21:00:00", 1, None, "search"),
    (491, 60, 41, "2024-02-01 21:00:00", 1, None, "playlist"),
    (492, 60, 96, "2024-02-15 22:00:00", 0, 55,   "radio"),
    (493, 60,105, "2024-03-01 21:30:00", 1, None, "recommendation"),
    # --- User 61 (jazz_new_york) — jazz + neo-soul
    (494, 61, 27, "2024-01-05 20:00:00", 1, None, "search"),
    (495, 61, 28, "2024-01-05 20:05:00", 1, None, "artist_page"),
    (496, 61, 74, "2024-01-12 21:00:00", 1, None, "recommendation"),
    (497, 61, 80, "2024-01-20 20:00:00", 0, 65,   "radio"),
    (498, 61, 27, "2024-02-01 21:00:00", 1, None, "playlist"),
    (499, 61, 28, "2024-02-10 20:30:00", 1, None, "search"),
    (500, 61, 74, "2024-02-20 21:00:00", 1, None, "recommendation"),
    (501, 61, 80, "2024-03-02 20:00:00", 1, None, "playlist"),
    # --- User 62 (indie_cape) — indie pop + folk
    (502, 62, 34, "2024-01-06 18:00:00", 1, None, "search"),
    (503, 62, 35, "2024-01-06 18:04:00", 1, None, "artist_page"),
    (504, 62, 57, "2024-01-15 19:00:00", 0, 80,   "recommendation"),
    (505, 62, 75, "2024-01-22 18:00:00", 1, None, "search"),
    (506, 62, 34, "2024-02-05 19:00:00", 1, None, "playlist"),
    (507, 62, 36, "2024-02-15 18:30:00", 1, None, "recommendation"),
    # --- User 63 (bass_sao_paulo) — latin + cumbia
    (508, 63, 51, "2024-01-04 19:00:00", 1, None, "search"),
    (509, 63, 52, "2024-01-04 19:04:00", 1, None, "artist_page"),
    (510, 63, 84, "2024-01-10 18:00:00", 1, None, "recommendation"),
    (511, 63, 85, "2024-01-10 18:04:00", 1, None, "artist_page"),
    (512, 63, 99, "2024-01-18 19:00:00", 1, None, "search"),
    (513, 63, 51, "2024-02-01 19:00:00", 1, None, "playlist"),
    (514, 63, 84, "2024-02-10 18:30:00", 1, None, "search"),
    (515, 63, 99, "2024-03-01 19:00:00", 1, None, "recommendation"),
    # --- User 64 (synth_chicago) — synth-pop
    (516, 64, 24, "2024-01-05 21:00:00", 1, None, "playlist"),
    (517, 64, 25, "2024-01-05 21:04:00", 1, None, "playlist"),
    (518, 64, 26, "2024-01-05 21:08:00", 1, None, "playlist"),
    (519, 64,101, "2024-01-12 22:00:00", 1, None, "recommendation"),
    (520, 64, 24, "2024-02-01 21:00:00", 1, None, "search"),
    (521, 64,101, "2024-02-10 22:00:00", 1, None, "playlist"),
    (522, 64, 26, "2024-03-01 21:30:00", 0, 42,   "radio"),
    # --- User 65 (world_music_fan) — world music mix
    (523, 65, 37, "2024-01-05 17:00:00", 1, None, "search"),
    (524, 65, 38, "2024-01-05 17:04:00", 1, None, "artist_page"),
    (525, 65, 84, "2024-01-10 18:00:00", 1, None, "recommendation"),
    (526, 65, 47, "2024-01-18 19:00:00", 1, None, "search"),
    (527, 65, 98, "2024-01-25 17:00:00", 1, None, "recommendation"),
    (528, 65, 37, "2024-02-01 18:00:00", 1, None, "playlist"),
    (529, 65, 98, "2024-02-10 17:30:00", 0, 55,   "radio"),
    (530, 65, 84, "2024-03-01 18:00:00", 1, None, "playlist"),
    # --- User 66 (tech_nairobi) — afrobeats
    (531, 66, 59, "2024-01-06 17:00:00", 1, None, "search"),
    (532, 66, 60, "2024-01-06 17:04:00", 1, None, "artist_page"),
    (533, 66, 22, "2024-01-12 16:00:00", 1, None, "recommendation"),
    (534, 66,103, "2024-01-20 17:00:00", 1, None, "search"),
    (535, 66, 59, "2024-02-05 17:00:00", 1, None, "playlist"),
    (536, 66,103, "2024-03-01 17:00:00", 1, None, "recommendation"),
    # --- User 67 (k_indie_busan) — K-Pop + indie
    (537, 67, 76, "2024-01-04 15:00:00", 1, None, "search"),
    (538, 67, 77, "2024-01-04 15:04:00", 1, None, "artist_page"),
    (539, 67, 34, "2024-01-12 16:00:00", 0, 40,   "recommendation"),
    (540, 67, 35, "2024-01-20 15:00:00", 1, None, "search"),
    (541, 67, 76, "2024-02-01 15:00:00", 1, None, "playlist"),
    (542, 67, 78, "2024-02-15 16:00:00", 1, None, "search"),
    # --- User 68 (latin_miami) — latin + cumbia
    (543, 68, 10, "2024-01-05 18:00:00", 1, None, "search"),
    (544, 68, 11, "2024-01-05 18:04:00", 1, None, "artist_page"),
    (545, 68, 12, "2024-01-05 18:08:00", 1, None, "artist_page"),
    (546, 68, 84, "2024-01-12 19:00:00", 1, None, "recommendation"),
    (547, 68, 99, "2024-01-20 18:00:00", 1, None, "search"),
    (548, 68, 10, "2024-02-01 18:00:00", 1, None, "playlist"),
    (549, 68, 84, "2024-02-10 19:00:00", 1, None, "search"),
    (550, 68, 99, "2024-03-01 18:30:00", 0, 45,   "radio"),
    # --- User 69 (afro_london) — afrobeats
    (551, 69, 22, "2024-01-05 18:00:00", 1, None, "search"),
    (552, 69, 23, "2024-01-05 18:04:00", 1, None, "artist_page"),
    (553, 69, 59, "2024-01-12 17:00:00", 1, None, "recommendation"),
    (554, 69, 60, "2024-01-12 17:04:00", 1, None, "artist_page"),
    (555, 69, 69, "2024-01-20 18:00:00", 1, None, "search"),
    (556, 69, 22, "2024-02-01 18:00:00", 1, None, "playlist"),
    (557, 69,103, "2024-02-10 17:30:00", 1, None, "recommendation"),
    (558, 69, 59, "2024-03-01 18:00:00", 1, None, "search"),
    # --- User 70 (chiptune_tokyo) — hyperpop + J-Pop
    (559, 70, 91, "2024-01-06 20:00:00", 1, None, "search"),
    (560, 70, 92, "2024-01-06 20:03:00", 1, None, "artist_page"),
    (561, 70,  8, "2024-01-12 21:00:00", 0, 30,   "recommendation"),
    (562, 70,  9, "2024-01-20 20:00:00", 1, None, "search"),
    (563, 70, 93, "2024-02-01 20:00:00", 1, None, "playlist"),
    (564, 70, 91, "2024-02-15 21:00:00", 1, None, "search"),
    # --- User 71 (classic_vienna) — jazz + post-rock
    (565, 71, 27, "2024-01-05 20:00:00", 1, None, "search"),
    (566, 71, 28, "2024-01-05 20:05:00", 1, None, "artist_page"),
    (567, 71, 88, "2024-01-12 21:00:00", 1, None, "recommendation"),
    (568, 71, 89, "2024-01-12 21:07:00", 1, None, "artist_page"),
    (569, 71, 74, "2024-01-20 20:00:00", 1, None, "search"),
    (570, 71, 27, "2024-02-01 21:00:00", 1, None, "playlist"),
    (571, 71, 88, "2024-02-10 20:30:00", 1, None, "recommendation"),
    (572, 71, 89, "2024-03-01 21:00:00", 0, 90,   "radio"),
    # --- User 72 (trap_atlanta_2) — hip-hop fusion
    (573, 72, 45, "2024-01-06 21:00:00", 1, None, "search"),
    (574, 72,102, "2024-01-06 21:04:00", 0, 45,   "artist_page"),
    (575, 72, 44, "2024-01-15 22:00:00", 1, None, "recommendation"),
    (576, 72, 45, "2024-02-01 21:00:00", 1, None, "playlist"),
    (577, 72,102, "2024-02-10 22:00:00", 1, None, "search"),
    # --- User 73 (ambient_sydney) — ambient
    (578, 73, 55, "2024-01-06 22:00:00", 1, None, "search"),
    (579, 73, 56, "2024-01-06 22:07:00", 1, None, "artist_page"),
    (580, 73,100, "2024-01-12 23:00:00", 1, None, "recommendation"),
    (581, 73, 19, "2024-01-20 22:00:00", 1, None, "search"),
    (582, 73, 55, "2024-02-01 23:00:00", 1, None, "playlist"),
    (583, 73,100, "2024-02-10 22:30:00", 1, None, "recommendation"),
    (584, 73, 56, "2024-03-01 22:00:00", 1, None, "search"),
    # --- User 74 (metal_prague) — metal + techno
    (585, 74, 17, "2024-01-05 22:00:00", 1, None, "search"),
    (586, 74, 18, "2024-01-05 22:05:00", 1, None, "artist_page"),
    (587, 74,110, "2024-01-12 23:00:00", 0, 60,   "recommendation"),
    (588, 74, 17, "2024-02-01 22:00:00", 1, None, "playlist"),
    (589, 74,110, "2024-02-10 23:00:00", 1, None, "search"),
    # --- User 75 (reggaeton_lima) — latin + cumbia
    (590, 75, 10, "2024-01-06 19:00:00", 1, None, "search"),
    (591, 75, 11, "2024-01-06 19:04:00", 1, None, "artist_page"),
    (592, 75, 84, "2024-01-12 18:00:00", 1, None, "recommendation"),
    (593, 75, 86, "2024-01-12 18:04:00", 1, None, "artist_page"),
    (594, 75, 99, "2024-01-20 19:00:00", 1, None, "search"),
    (595, 75, 10, "2024-02-01 19:00:00", 1, None, "playlist"),
    (596, 75, 84, "2024-02-10 18:30:00", 0, 50,   "radio"),
    (597, 75, 99, "2024-03-01 19:00:00", 1, None, "recommendation"),
    # --- 2025 new song streams — existing + new users
    (598,  1, 96, "2025-01-05 20:00:00", 1, None, "search"),
    (599, 11, 96, "2025-01-08 23:00:00", 1, None, "recommendation"),
    (600, 22, 96, "2025-01-10 22:00:00", 1, None, "search"),
    (601, 35, 96, "2025-01-12 23:00:00", 1, None, "playlist"),
    (602, 56, 96, "2025-01-15 23:00:00", 1, None, "search"),
    (603,  4, 97, "2025-01-05 15:00:00", 1, None, "search"),
    (604,  9, 97, "2025-01-08 14:00:00", 1, None, "recommendation"),
    (605, 34, 97, "2025-01-10 15:00:00", 1, None, "search"),
    (606, 55, 97, "2025-01-12 14:00:00", 1, None, "playlist"),
    (607, 23, 98, "2025-01-06 19:00:00", 1, None, "search"),
    (608, 28, 98, "2025-01-10 20:00:00", 1, None, "recommendation"),
    (609, 65, 98, "2025-01-15 17:00:00", 0, 40,   "radio"),
    (610,  3, 99, "2025-01-05 18:00:00", 1, None, "search"),
    (611, 17, 99, "2025-01-10 19:00:00", 1, None, "recommendation"),
    (612, 63, 99, "2025-01-15 19:00:00", 1, None, "search"),
    (613, 31,100, "2025-01-06 23:00:00", 1, None, "search"),
    (614, 47,100, "2025-01-10 22:00:00", 1, None, "recommendation"),
    (615, 73,100, "2025-01-15 22:00:00", 1, None, "search"),
    (616,  7,101, "2025-01-05 22:00:00", 1, None, "search"),
    (617, 18,101, "2025-01-10 20:00:00", 1, None, "recommendation"),
    (618, 43,101, "2025-01-15 21:00:00", 1, None, "playlist"),
    (619, 64,101, "2025-01-20 22:00:00", 1, None, "search"),
    (620, 28,102, "2025-01-06 20:00:00", 1, None, "search"),
    (621, 38,102, "2025-01-10 19:00:00", 0, 55,   "radio"),
    (622, 72,102, "2025-01-15 22:00:00", 1, None, "search"),
    (623, 29,103, "2025-01-05 18:00:00", 1, None, "search"),
    (624, 42,103, "2025-01-10 16:00:00", 1, None, "recommendation"),
    (625, 66,103, "2025-01-15 17:00:00", 1, None, "search"),
    (626, 69,103, "2025-01-20 18:00:00", 1, None, "playlist"),
    (627, 14,104, "2025-01-06 18:00:00", 1, None, "search"),
    (628, 44,104, "2025-01-10 20:00:00", 1, None, "recommendation"),
    (629, 58,104, "2025-01-15 20:00:00", 0, 50,   "radio"),
    (630,  9,105, "2025-01-05 14:00:00", 1, None, "search"),
    (631, 34,105, "2025-01-10 15:00:00", 1, None, "recommendation"),
    (632, 55,105, "2025-01-15 14:00:00", 1, None, "playlist"),
    (633, 30,106, "2025-01-05 20:00:00", 1, None, "search"),
    (634, 43,106, "2025-01-10 22:00:00", 1, None, "recommendation"),
    (635, 60,106, "2025-01-15 21:00:00", 1, None, "search"),
    (636,  6,107, "2025-01-06 19:00:00", 1, None, "search"),
    (637, 24,107, "2025-01-10 21:00:00", 1, None, "recommendation"),
    (638, 19,107, "2025-01-15 18:00:00", 0, 60,   "radio"),
    (639, 32,108, "2025-01-06 19:00:00", 1, None, "search"),
    (640, 57,108, "2025-01-10 20:00:00", 1, None, "recommendation"),
    (641, 62,108, "2025-01-15 18:00:00", 1, None, "search"),
    (642, 23,109, "2025-01-06 19:00:00", 1, None, "search"),
    (643, 28,109, "2025-01-10 20:00:00", 1, None, "recommendation"),
    (644, 38,109, "2025-01-15 19:00:00", 0, 45,   "radio"),
    (645, 27,110, "2025-01-06 20:00:00", 1, None, "search"),
    (646, 54,110, "2025-01-10 21:00:00", 1, None, "recommendation"),
    (647, 57,110, "2025-01-15 20:00:00", 1, None, "playlist"),
    (648, 35,110, "2025-01-06 23:00:00", 1, None, "search"),
    (649, 26,110, "2025-01-10 23:00:00", 1, None, "recommendation"),
    (650, 74,110, "2025-01-15 23:00:00", 1, None, "search"),
]
...
SEED_PLAYLISTS = [
    ...
    (36, "Hyperpop Heaven",       51, 1, "2024-01-05"),
    (37, "Neo Soul Sunrise",      52, 1, "2024-01-06"),
    (38, "Cumbia Futura",         53, 1, "2024-01-04"),
    (39, "Post-Rock Horizons",    54, 0, "2024-01-07"),
    (40, "K-Pop Next Gen",        55, 1, "2024-01-03"),
    (41, "Deep House Sessions",   56, 1, "2024-01-05"),
    (42, "World Fusion Mix",      65, 1, "2024-01-05"),
    (43, "Jazz Downtown",         61, 1, "2024-01-05"),
    (44, "Synth City",            64, 1, "2024-01-05"),
    (45, "Afrobeat Diaspora",     69, 1, "2024-01-05"),
    (46, "Lo-Fi Porch",           59, 1, "2024-01-04"),
    (47, "Indie Wanderer",        62, 0, "2024-01-06"),
    (48, "Latin World",           68, 1, "2024-01-05"),
    (49, "Ambient Cosmos",        73, 1, "2024-01-06"),
    (50, "New Releases 2025",      1, 1, "2025-01-01"),
]
...
SEED_PLAYLIST_SONGS = [
    ...
    # Playlist 36 (Hyperpop Heaven)
    (36,91,1,"2024-01-05"),(36,92,2,"2024-01-05"),(36,93,3,"2024-01-05"),(36,94,4,"2024-01-06"),(36,95,5,"2024-01-06"),
    # Playlist 37 (Neo Soul Sunrise)
    (37,80,1,"2024-01-06"),(37,81,2,"2024-01-06"),(37,82,3,"2024-01-07"),(37,83,4,"2024-01-07"),
    # Playlist 38 (Cumbia Futura)
    (38,84,1,"2024-01-04"),(38,85,2,"2024-01-04"),(38,86,3,"2024-01-05"),(38,87,4,"2024-01-05"),
    # Playlist 39 (Post-Rock Horizons)
    (39,88,1,"2024-01-07"),(39,89,2,"2024-01-07"),(39,90,3,"2024-01-08"),
    # Playlist 40 (K-Pop Next Gen)
    (40,76,1,"2024-01-03"),(40,77,2,"2024-01-03"),(40,78,3,"2024-01-04"),(40,79,4,"2024-01-04"),(40,97,5,"2024-01-04"),
    # Playlist 41 (Deep House Sessions)
    (41,1,1,"2024-01-05"),(41,2,2,"2024-01-05"),(41,61,3,"2024-01-05"),(41,62,4,"2024-01-06"),(41,96,5,"2024-01-06"),
    # Playlist 42 (World Fusion Mix)
    (42,37,1,"2024-01-05"),(42,84,2,"2024-01-05"),(42,47,3,"2024-01-06"),(42,98,4,"2024-01-06"),
    # Playlist 43 (Jazz Downtown)
    (43,27,1,"2024-01-05"),(43,28,2,"2024-01-05"),(43,74,3,"2024-01-05"),(43,80,4,"2024-01-06"),
    # Playlist 44 (Synth City)
    (44,24,1,"2024-01-05"),(44,25,2,"2024-01-05"),(44,26,3,"2024-01-05"),(44,101,4,"2024-01-06"),
    # Playlist 45 (Afrobeat Diaspora)
    (45,22,1,"2024-01-05"),(45,23,2,"2024-01-05"),(45,59,3,"2024-01-05"),(45,103,4,"2024-01-06"),(45,69,5,"2024-01-06"),
    # Playlist 46 (Lo-Fi Porch)
    (46,19,1,"2024-01-04"),(46,20,2,"2024-01-04"),(46,21,3,"2024-01-04"),(46,70,4,"2024-01-05"),
    # Playlist 47 (Indie Wanderer)
    (47,34,1,"2024-01-06"),(47,35,2,"2024-01-06"),(47,57,3,"2024-01-06"),(47,75,4,"2024-01-07"),
    # Playlist 48 (Latin World)
    (48,10,1,"2024-01-05"),(48,11,2,"2024-01-05"),(48,84,3,"2024-01-05"),(48,99,4,"2024-01-06"),(48,86,5,"2024-01-06"),
    # Playlist 49 (Ambient Cosmos)
    (49,55,1,"2024-01-06"),(49,56,2,"2024-01-06"),(49,100,3,"2024-01-06"),(49,19,4,"2024-01-07"),
    # Playlist 50 (New Releases 2025)
    (50,96,1,"2025-01-05"),(50,97,2,"2025-01-05"),(50,98,3,"2025-01-06"),(50,99,4,"2025-01-06"),
...
TASK_EASY = TaskDef(
    ...
    questions=[
        ...
        Question("easy_q2",
                 "List the top 5 artists by monthly_listeners. Return id, name, country, monthly_listeners. Order by monthly_listeners descending, break ties by name ascending.",
                 _easy_q2_rows, True, ["id", "name", "country", "monthly_listeners"]),
        Question("easy_q3",
                 "How many songs are in each genre? Return genre and song_count, ordered by song_count descending, break ties by genre ascending.",
...
TASK_MEDIUM = TaskDef(
    ...
    questions=[
        Question("medium_q1",
                 "What are the top 10 most streamed songs? Return title and stream_count, ordered by stream_count descending, break ties by title ascending.",
                 _medium_q1_rows, True, ["title", "stream_count"]),
        Question("medium_q2",
                 "What is the stream completion rate per artist? Return artist_name and completion_rate (0–100, 2 decimal places), ordered by completion_rate descending, break ties by artist_name ascending.",
                 _medium_q2_rows, True, ["artist_name", "completion_rate"]),
        Question("medium_q3",
                 "How many streams came from each source? Return source and stream_count, ordered by stream_count descending, break ties by source ascending.",
                 _medium_q3_rows, True, ["source", "stream_count"]),
        Question("medium_q4",
                 "Which users have listened to the most unique songs? Return username and unique_songs, top 10 ordered by unique_songs descending, break ties by username ascending.",
                 _medium_q4_rows, True, ["username", "unique_songs"]),
        Question("medium_q5",
                 "Which moods have the most completed streams? Return mood and stream_count for completed streams only, ordered by stream_count descending, break ties by mood ascending.",
...
TASK_HARD = TaskDef(
    ...
    questions=[
        Question("hard_q1",
                 "Rank songs by stream count within their genre using a window function. Return title, stream_count, and genre_rank, ordered by genre ascending, then genre_rank ascending, break ties by title ascending.",
        ...
        Question("hard_q3",
                 "Find songs with above-average stream counts using a CTE. Return title, genre, and stream_count, ordered by stream_count descending, break ties by title ascending.",
                 _hard_q3_rows, True, ["title", "genre", "stream_count"]),
        Question("hard_q4",
                 "Calculate skip rate per artist. Return artist_name, skip_count, total_streams, and skip_rate (0–100, 2 decimal places), ordered by skip_rate descending, break ties by artist_name ascending.",
                 _hard_q4_rows, True, ["artist_name", "skip_count", "total_streams", "skip_rate"]),
        Question("hard_q5",
                 "Which playlists have the most songs? Return playlist_name, username of the creator, and song_count, ordered by song_count descending, break ties by playlist_name ascending.",
